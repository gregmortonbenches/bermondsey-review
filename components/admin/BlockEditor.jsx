  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        // leading-[26px]: 8px over this text-lg's fixed 18px, matching
        ...
        // the same "font-size + 8px" target is just spelled out directly
        // here instead. See that file's own comment for why 8px (not the
        // old leading-relaxed's 1.625 ratio, which grows the gap between
        // font-size and line-height rather than holding it constant).
        className={`font-body text-lg leading-[26px] text-ink outline-none [&_a]:underline [&_a]:underline-offset-2 [&_br.pb]:block [&_br.pb]:mt-3 ${
          isFirst ? "drop-cap" : ""
        }`}
