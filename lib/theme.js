export const DEFAULT_SITE_SETTINGS = {
  ...
  // from /admin/site instead of hardcoded in each page's own JSX. Keyed
  // by page slug rather than one shared shape, so adding a new page's
  // copy later is just a new key here, no schema change.
  page_copy: {
    archive: {
      title: "Archive",
